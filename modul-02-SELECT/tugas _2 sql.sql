...
-- Untuk menampilkan semua data yang ada di schemas
SHOW DATABASES;

-- Untuk menampilkan struktur kolom dari tabel Driver dalam database yang sedang aktif
DESCRIBE driver;

-- Untuk mengambil atau menampilkan data dari kolom Nama di tabel driver
SELECT Nama FROM driver;

-- untuk mengambil data dari dua kolom, yaitu Nama dan Nik, dari tabel Driver.
SELECT Nama, Nik FROM  Driver;

-- untuk mengambil data dari kolom Nama dalam tabel driver
SELECT driver.Nama FROM driver;

--  untuk mengambil data dari kolom Nama di tabel driver, yang berada di dalam database aplikasi_gojek
SELECT gojek.driver.Nama FROM driver;

-- untuk mengambil data dari kolom Nama di tabel driver, dan mengganti alias nama kolom yang ditampilkan menjadi Nm
SELECT Nama AS Nm FROM driver;

-- untuk mengambil data dari kolom Nama dalam tabel driver, kemudian memberikan alias pada kolom tersebut,
-- menggantikan nama kolom yang asli dengan nama baru
SELECT Nama Nm FROM driver;

-- untuk Mengambil data dari kolom Nama dalam tabel driver, sambil memberikan alias drvr untuk tabel tersebut
SELECT Nama FROM driver AS drvr;

-- untuk mengambil data dari kolom Nama dalam tabel driver, dengan menggunakan alias drvr untuk tabel driver
SELECT drvr.Nama FROM driver AS drvr;